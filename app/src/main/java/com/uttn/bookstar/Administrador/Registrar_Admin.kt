package com.uttn.bookstar.Administrador
...
import com.uttn.bookstar.MainActivity
import com.uttn.bookstar.R
import com.uttn.bookstar.databinding.ActivityRegistrarAdminBinding
...
class Registrar_Admin : AppCompatActivity() {
    ...
    private fun ValidarInformacion() {
        ...
        if (nombres.isEmpty()){
            binding.EtNombresAdmin.error = "Ingresar nombres"
            binding.EtNombresAdmin.requestFocus()
        }
       else if (email.isEmpty()){
            binding.EtEmailAdmin.error = "Ingresar email"
    ...
    private fun CrearCuentaAdmin(email: String, password: String) {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
            ...
            .addOnFailureListener{e->
                ...
                Toast.makeText(applicationContext, "No se pudo crear la cuenta debido a ${e.message}", Toast.LENGTH_SHORT)
                    .show()
            }
    }
